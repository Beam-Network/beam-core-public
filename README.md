...
| Path | Description |
|------|-------------|
| `packages/transfer-runtime/src/transfer-runtime/assignment-engine.ts` | Assignment and recovery allocation pipeline used in production, including transfer and Room capability eligibility. |
